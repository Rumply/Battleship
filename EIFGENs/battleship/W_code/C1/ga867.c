...
extern void F867_8480(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F867_8480 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_n4
	...
	RTEAA(l_feature_name, 866, Current, 0, 1, 14159);
	RTSA(Dtype(Current));
	RTSC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 6408, 0x38000000, 1); /* id */
	*(EIF_NATURAL_32 *)(Current + RTWA(6408, Dtype(Current))) = (EIF_NATURAL_32) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F867_8481 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_UINT32;
	r.it_n4 = *(EIF_NATURAL_32 *)(Current + RTWA(6408,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F867_8482 (EIF_REFERENCE Current)
{
	...
	tu4_1 = *(EIF_NATURAL_32 *)(Current + RTWA(6408, Dtype(Current)));
