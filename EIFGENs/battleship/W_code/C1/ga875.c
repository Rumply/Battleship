...
#define ui4_1 ui4_1x.it_i4
	...
	RTCC(arg1, 874, l_feature_name, 1, eif_new_type(920, 0x01), 0x01);
	RTCC(arg2, 874, l_feature_name, 2, eif_new_type(904, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(6448, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6449, 0xF8000398, 0); /* haptic */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(6449, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(4);
	RTDBGAA(Current, dtype, 6450, 0xF8000388, 0); /* effect */
	RTAR(Current, arg2);
