...
extern void F881_10088(EIF_REFERENCE, int);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 880, Current, 0, 0, 14745);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 880, Current, 1, 3, 14746);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ub3 ub3x.it_b
	...
	RTEAA(l_feature_name, 880, Current, 0, 0, 14749);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 880, Current, 1, 0, 14752);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
void F881_10088 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 880, Current, 0, 10087);
	RTSA(dtype);
	RTME(dtype, 0);
