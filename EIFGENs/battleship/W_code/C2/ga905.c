...
extern void F905_10126(EIF_REFERENCE, int);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		tu2_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7309, dtype))(Current)).it_n2);
...
void F905_10126 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 904, Current, 0, 10125);
	RTSA(dtype);
	RTME(dtype, 0);
